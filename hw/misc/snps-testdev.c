...
static void snps_test_reset(SnpsTestState *d)
{
    return;
}

static uint64_t snps_test_read(void *opaque, hwaddr addr, unsigned size)
{
...
static void snps_test_write(void *opaque, hwaddr addr, uint64_t val, unsigned size)
{
    SnpsTestBar *d = opaque;
...
static void snps_test_uninit(PCIDevice *dev)
{
