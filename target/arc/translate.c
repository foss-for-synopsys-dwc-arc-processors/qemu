 ...
 */
static void gen_cc_epilogue(DisasCtxt *ctx)
{
    if (ctx->insn.cc) {
...
#define NEW_ARC_REG(TCGV, FIELD) \
    ...
    static const struct { TCGv_i32 *ptr; int off; const char *name; } r32[] = {
        ...
        NEW_ARC_REG(cpu_is_delay_slot_instruction, stat.is_delay_slot_instruction)
 ...
 */
static bool check_enter_leave_nr_regs(DisasCtxt *ctx,
                                      uint8_t      regs)
{
    ...
    if ((rgf_num_regs == 32 && regs > 14) ||
        ...
        TCGv_i32 tcg_index = tcg_const_i32(EXCP_INST_ERROR);
        TCGv_i32 tcg_cause = tcg_const_i32(0);
        TCGv_i32 tcg_param = tcg_const_i32(0);
 ...
 */
static bool check_delay_or_execution_slot(DisasCtxt *ctx)
{
    if (ctx->in_delay_slot) {
        TCGv_i32 tcg_index = tcg_const_i32(EXCP_INST_ERROR);
        TCGv_i32 tcg_cause = tcg_const_i32(0x1);
        TCGv_i32 tcg_param = tcg_const_i32(0x0);
 ...
 */
static void check_addr_is_word_aligned(DisasCtxt *ctx,
                                       TCGv addr)
{
    TCGLabel *l1 = gen_new_label();
    TCGv tmp = tcg_temp_local_new_i32();

    tcg_gen_andi_i32(tmp, addr, 0x3);
    ...
    TCGv_i32 tcg_index = tcg_const_i32(EXCP_MISALIGNED);
    TCGv_i32 tcg_cause = tcg_const_i32(0x0);
    TCGv_i32 tcg_param = tcg_const_i32(0x0);
...
int arc_gen_ENTER(DisasContext *ctx)
{
    ...
    TCGv temp_sp = tcg_temp_local_new_i32();
...
{
    TCGv_i32 tcg_index = tcg_const_i32(EXCP_SWI);
    TCGv_i32 tcg_cause = tcg_const_i32(0);
...
{
    TCGv_i32 tcg_index = tcg_const_i32(EXCP_TRAP);
    TCGv_i32 tcg_cause = tcg_const_i32(0);
