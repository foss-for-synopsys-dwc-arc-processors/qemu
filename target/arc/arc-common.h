...
#define ARC_OPCODE_HS_HS5X ( ARC_OPCODE_ARCv2HS | ARC_OPCODE_ARC32)
...
#define ARC_OPCODE_V3_ALL   (ARC_OPCODE_ARC64 | ARC_OPCODE_ARC32)
...
enum arc_cpu_family {
    ...
    ARC_OPCODE_ARC32  = 1 << 5,
    ARC_OPCODE_ARC64  = 1 << 6
};
